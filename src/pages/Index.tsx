          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                SkillShare Campus is your all-in-one platform for learning new skills, 
                connecting with like-minded individuals, and building your professional network. 
      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Join SkillShare Campus today and unlock access to hundreds of courses, 
            a vibrant community, and tools to accelerate your growth.
          </p>
